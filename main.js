// პირველი : რიცხვი არის თუ არა 5-ის ჯერადი
function isMultipleOfFive(number) {
    return number % 5 === 0;
}

// მეორე : ფასდაკლეების შედეგ გადასახდელი თანხა
function calculateDiscountPrice(originalPrice, discountPercentage) {
    return originalPrice - (originalPrice * (discountPercentage / 100));
}

// მესამე : ვალუტის კოდის შესაბამისი სიმბოლო
...
// მეოთხე : Uppercase სტრინგის გადაყვანა Lowercase-ში
function toLowerCaseString(input) {
    return input.toLowerCase();
}

// მეხუთე : კენტი რიცხვებას გაფილტვრა
function filterOddNumbers(numbers) {
    return numbers.filter(num => num % 2 !== 0);
}

// მეექვსე* : უმცირესი ფასის მქონე ელემენტის პოვნა
...
// მეშვიდე* : find ფუნქცია კონკრეტული title ველისთვის
